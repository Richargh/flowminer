...
import de.richargh.flowminer.importer.gitmining.app.api.WorkItem
import de.richargh.flowminer.importer.gitmining.app.api.WorkItems
...
fun extractWorkItems(commits: List<Commit>): WorkItems {
    ...
    return WorkItems(
        workItems.values.map(
            MutableWorkKey::toWorkItem
        )
    )
}
