...
class CommitBuilder {
    ...
    private var branch: BranchNameCertainty = BranchNameCertainty.Nameless
    ...
    fun headRef(branchName: String) = apply { this.refs += Ref.LocalHead(BranchName(branchName)) }
    ...
    fun nobranch() = apply { this.branch = BranchNameCertainty.Nameless }
    fun branch(branch: BranchNameCertainty.Named) = apply { this.branch = branch }
    fun certainBranch(name: String) = apply { this.branch = BranchNameCertainty.Named.Certain(BranchName(name)) }
    fun inferredBranch(name: String) = apply { this.branch = BranchNameCertainty.Named.Inferred(BranchName(name)) }
    ...
    fun build(): Commit = Commit(
        ...
        workKeys = workKeys,
        branch = branch,
        isOnActiveBranch = isOnActiveBranch
    )
}
