...
class CommitBuilder {
    ...
    private var branch: NameCertainty = NameCertainty.Nameless
    ...
    fun nobranch() = apply { this.branch = NameCertainty.Nameless }
    fun branch(branch: NameCertainty.Named) = apply { this.branch = branch }
    fun certainBranch(name: String) = apply { this.branch = NameCertainty.Named.Certain(BranchName(name)) }
    fun inferredBranch(name: String) = apply { this.branch = NameCertainty.Named.Inferred(BranchName(name)) }
