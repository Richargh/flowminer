...
import de.richargh.flowminer.importer.gitfixtures.app.api.hash
...
import de.richargh.flowminer.importer.sharedfixtures.time.app.testNow2025
import de.richargh.flowminer.importer.sharedfixtures.time.app.toInstant
...
val BranchDetectionTest by testSuite {
    ...
    test("LastCommitTracking: should set lastCommit equal to firstCommit for single commit branch") {
        // main: 0 (origin/main)
    ...
    test("LastCommitTracking: should track lastCommit as most recent commit on branch") {
    ...
    test("LastCommitTracking: should track lastCommit for merged branch") {
    ...
    test("LastCommitTracking: should track lastCommit for branch with multiple commits before merge") {
    ...
    test("LastCommitTracking: should track lastCommit for inferred branch") {
    ...
    test("LastCommitTracking: should track lastCommit for unnamed branch") {
    ...
    test("should extract branch info for initial commit") {
        // main: 0 (origin/main)
    ...
    test("should extract branch info for multiple commits on branch") {
        // main: 0───1───2 (origin/main)
    ...
    test("should extract branch info from merge commits") {
        // main:    0───2 (origin/main) [merge feature-login]
        //           \ /
        // feature:   1 (origin/feature-login)
    ...
    test("should extract branch info when one branch is unmerged") {
    ...
    test("should track first and last commits by date even when branch has many commits") {
    ...
    test("OctopusMerges: should handle octopus merge with three parents and branch names from tips") {
    ...
    test("OctopusMerges: should handle octopus merge with three parents and infer branch names from merge message") {
        // trunk: 0───1───────────5 (HEAD -> trunk, origin/trunk) [octopus merge feat-a and feat-b]
        //         \    \        /
        // feat-a:  └─2──\──────/ (deleted, inferred from merge message)
        //                \    /
    ...
    test("OctopusMerges: should handle octopus merge with three parents and unnamed branches") {
        // trunk: 0───1───────────5 (HEAD -> trunk, origin/trunk) [octopus merge feat-a and feat-b]
        //         \    \        /
        // feat-a:  └─2──\──────/ (deleted, inferred from merge message)
        //                \    /
    ...
    test("OctopusMerges: should handle octopus merge with three parents, one named, one unnamed") {
        // trunk: 0───1───────────5 (HEAD -> trunk, origin/trunk) [octopus merge feat-a and feat-b]
        //         \    \        /
        // feat-a:  └─2──\──────/ (deleted, inferred from merge message)
        //                \    /
    ...
    // NestedBranches tests

    test("NestedBranches: should handle feature branch created from another feature branch") {
    ...
    // MultipleMerges tests

    test("MultipleMerges: should track only the last merge of the branch") {
    ...
    test("MultipleMerges: should handle main merged twice into feature branch") {
    ...
    test("MultipleMerges: should handle main merged twice into feature branch before merge into main") {
        // Main is merged into feature branch twice to keep it up to date
        // main:    0───1─────────4───7 (HEAD -> main, origin/main)
        //           \   \         \ /
    ...
    test("should extract branch info from merge commits with explicit merge commit") {
        // trunk: 0───1───────4 (HEAD -> trunk, origin/trunk) [merge feat]
        //         \         /
        // feat:    └─2───3─┘ (origin/feat)
    ...
    test("should extract branch info from merge commits after branch is deleted and mark it as inferred") {
        // trunk: 0───1───────4 (HEAD -> trunk, origin/trunk) [merge feat]
        //         \         /
        // feat:    └─2───3─┘ (deleted, inferred from merge message)
    ...
    test("should include branch as unnamed when branch is deleted and name cannot be inferred from merge message") {
        // trunk: 0───1───────4 (HEAD -> trunk, origin/trunk) [merge with custom message]
        //         \         /
        // ???:     └─2───3─┘ (deleted, cannot infer name)
    ...
    test("should extract branch info when main is merged into feat before feat is merged back") {
    ...
    test("should identify multiple inferred branches") {
    ...
    test("should identify multiple unnamed branches") {
        // trunk: 0───1───────4───────7 (HEAD -> trunk, origin/trunk)
        //         \         / \     /
        // ???:     └─2───3─┘   \   / (deleted, cannot infer name)
        //                       \ /
    ...
    // BranchCompletion tests

    test("BranchCompletion: should mark branch as completed when merged with no additional commits") {
    ...
    test("BranchCompletion: should mark branch as not completed when it has commits after merge") {
    ...
    test("BranchCompletion: should mark branch as not completed when never merged") {
    ...
    test("BranchCompletion: should mark main as not completed at all times, here when a feature was merged into main") {
        // main:    0───2 (origin/main) [merge feature]
        //           \ /
        // feature:   1 (origin/feature)
    ...
    test("BranchCompletion: should mark main as not completed at all times, here when feature branch is created") {
        // main:    0 (origin/main)
        //           \
    ...
    test("BranchCompletion: should mark branch as not completed when commit after merge has backdated date") {
    ...
    test("BranchCompletion: should mark main as not completed at all times, here when merged into a feature branch") {
    ...
    // BranchActivity tests

    test("BranchActivity: should mark branch as active when last commit is within 3 months of current date") {
        // main: 0 (origin/main)
    ...
    test("BranchActivity: should mark branch as stale when last commit is older than 3 months") {
        // main: 0 (origin/main)
    ...
    test("BranchActivity: should mark branch as active when last commit is exactly 3 months ago") {
        // main: 0 (origin/main)
    ...
    test("BranchActivity: should mark branch as stale when last commit is just over 3 months ago") {
        // main: 0 (origin/main)
