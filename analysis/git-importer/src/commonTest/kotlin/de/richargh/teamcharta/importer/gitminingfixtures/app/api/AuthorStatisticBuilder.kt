package de.richargh.teamcharta.importer.gitminingfixtures.app.api
...
class AuthorStatisticBuilder {
    ...
    fun churn(type: CommitType, additions: Int, deletions: Int) = apply {
        this.churnByCommitType = this.churnByCommitType + (type to ChurnMetric(additions, deletions))
    }
