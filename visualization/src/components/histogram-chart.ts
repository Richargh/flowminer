...
export interface HistogramChartOption {
  xAxis: {
    type: 'category';
    data: string[];
  };
...
@customElement('histogram-chart')
export class HistogramChart extends LitElement {
  private chart: EChartsType | null = null;
  private currentOption: HistogramChartOption | null = null;
  ...
  private updateChartWithData(): void {
    ...
    const option: HistogramChartOption = {
      xAxis: {
        type: 'category',
        data: ranges,
      },
  ...
  getChartOption(): HistogramChartOption | null {
